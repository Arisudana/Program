...
Data disimpan dalam dataframe yang disebut `present`.

-  Tahun berapa saja yang termasuk dalam kumpulan data 
   ini? Apa dimensi dari dataframe dan apa saja nama   
   variabel atau kolom pada data?
   
-  Bagaimana jumlah data ini dibandingkan dengan data 
   Arbuthnot? Apakah mereka berada pada skala yang sama?

-  Buatlah plot yang menampilkan rasio laki-laki dan
   perempuan untuk setiap tahun dalam kumpulan data. Apa 
   yang kamu dapatkan?
   
-  Apakah pengamatan pada data Arbuthnot mengenai anak 
...
-  Pada tahun berapa kita melihat jumlah kelahiran  
   terbanyak di AS?  

You can refer to the help files or the R reference card 
    [http://cran.r-project.org/doc/contrib/Short-refcard.pdf](http://cran.r-project.org/doc/contrib/Short-refcard.pdf) to find helpful commands.
